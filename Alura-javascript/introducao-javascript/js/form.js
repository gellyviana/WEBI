//Pegando o elemento que será esboçado o código para inserção de novo paciente
var botaoAdicionar = document.querySelector("#adicionar-paciente");

//Função que escuta o evento de clique, denominada de função anônima
botaoAdicionar.addEventListener("click", function(event){
    //Função que previne o comportamento padrão do navegador
